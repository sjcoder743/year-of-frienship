const config = {
  ...
  */
  ...
  // 🔐 Passcode Page
  correctPasscode: "8273", // Change this to any 4-digit code (the passcode for access)
  passcodeTitle: "Enter Password", // Title displayed on the passcode entry page
  ...
  // 💌 Love Letter Page
  loveLetterMessage: "Hi, You are my bestesttt Friend! 💖", // Message displayed on the love letter page

  // 🎇 Closing Page
  closingMessage: "Thank you for everything, my bestest Friend! 💖 Wishing us many more wonderful years together.", // Closing message displayed
